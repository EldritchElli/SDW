...
Checks are used as a resolution mechanic that uses skills and attributes to
determine the outcome of a challenging task.

To make a Checks, roll multiple dice, glance at the dice to see how many
successes and fumbles the check scored.
...
matter. Items by default use up 2 Spaces. Inventory represents how much a
creature can carry. Creatures usually have 12 Spaces in their Inventory.
...
There are 3 main Mode that Characters can partake in at a given time: Combat
mode, Investigation mode, Downtime mode. Each mode changes how a Creature
interacts with the world and the possible actions, abilities or activities they
can perform. You can find more rules about modes in the Modes Section.
...
Damage is a number that represents how much harm something can inflict; Damage
can be variable by using dice and other mechanics to dictate the exact amount
of harm dealt to a creature or object. If you damage multiple targets, roll the
damage once only, each target takes the specified amount of damage.

## Stamina

Stamina represents how much energy you have make special actions.

## Abilities and Activities

Abilities are special actions that can be used in Combat Mode or Investigation
Mode. All Combat Abilities Stamina some may also use another resource while
Investigation mode Abilities use your entire turn to perform.

Activities are events you can partake in Downtime Activities use Hours as a
resource.
...
### Physical Attributes
Physical attributes focus on your character physical prowess in various areas
such as Stamina and Vitality.
...
### Mental
Mental attributes focus on your character mental prowess in various areas such
as Sorcery and Occultism.

#### Aptitude

Aptitude refers to your character's easy of learning new things, and item
discovery.
...
ranging from 0 to 6. Skills are divided into Knowledge Skills, and Practical
Skills.

### Knowledge Skills

knowledge skills rely on your character knowing about various topics, these
skills allow you to recall information in related fields of study. recalling
knowledge allows you to learn more about the world, creatures and items.
...
Practical skills unlike knowledge skills rely on your ability to perform
specialized actions.

#### Spellcasting

Spellcasting refers to your character's ability to cast spells.
...
Speach refers to your character's ability to speak publically in a decietful or
convincting way.
